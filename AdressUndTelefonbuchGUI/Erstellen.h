...
namespace AdressUndTelefonbuchGUI {
	...
	/// <summary>
	/// Summary for Erstellen
	/// </summary>
	public ref class Erstellen : public System::Windows::Forms::Form
	{
	public:
		Erstellen(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(83, 15);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(83, 56);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(154, 116);
			...
			this->label4->Location = System::Drawing::Point(21, 154);
			...
			this->label5->Location = System::Drawing::Point(21, 184);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(154, 151);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(154, 181);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(24, 246);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(216, 246);
			...
			this->ClientSize = System::Drawing::Size(393, 314);
			...
			this->Name = L"Erstellen";
			this->Text = L"Erstellen";
